...
SHIP_IMAGE_PATH = {
    ...
    4: "../bcog200/battleship_images/ship4.gif",
}
...
class Grid:
    ...
    def set_grid(self, score, ammo, ships):
        ...
        for (r, c) in self.miss_positions:
            x = c * self.row_distance
            y = r * self.col_height
...
class Game:
    ...
    def end(self):
        ...
        game_over_text = font.render(f"Final Score: {self.player.score}", "black", True, (255, 255, 255))
